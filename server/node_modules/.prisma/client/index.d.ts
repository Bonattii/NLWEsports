...
export namespace Prisma {
  ...
  */
  ...
  export class Prisma__GameClient<T, Null = never> implements PrismaPromise<T> {
    ...
    ads<T extends AdFindManyArgs = {}>(args?: Subset<T, AdFindManyArgs>): CheckSelect<T, PrismaPromise<Array<Ad>| Null>, PrismaPromise<Array<AdGetPayload<T>>| Null>>;
  ...
  export interface AdDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'Ad'> extends True ? CheckSelect<T, Prisma__AdClient<Ad>, Prisma__AdClient<AdGetPayload<T>>> : CheckSelect<T, Prisma__AdClient<Ad | null, null>, Prisma__AdClient<AdGetPayload<T> | null, null>>
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'Ad'> extends True ? CheckSelect<T, Prisma__AdClient<Ad>, Prisma__AdClient<AdGetPayload<T>>> : CheckSelect<T, Prisma__AdClient<Ad | null, null>, Prisma__AdClient<AdGetPayload<T> | null, null>>
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__AdClient<T, Null = never> implements PrismaPromise<T> {
    [prisma]: true;
    private readonly _dmmf;
    private readonly _fetcher;
    private readonly _queryType;
